...
void OptionsModel::Init()
{
    ...
    fUsediplexcoinTheme = settings.value("fUsediplexcoinTheme", true).toBool();	
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UsediplexcoinTheme:
            return QVariant(fUsediplexcoinTheme);			
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UsediplexcoinTheme:
            fUsediplexcoinTheme = value.toBool();
            settings.setValue("fUsediplexcoinTheme", fUsediplexcoinTheme);
            break;			
        default:
            break;
        }
